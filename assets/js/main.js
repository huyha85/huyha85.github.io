...
$(function(){
  ...
  $('.icons a').hover(
    function() { $(this).closest('.icons').parent().find('.link_hover_text').text( $(this).clone().children().remove().end().text() ); },
    function() { $(this).closest('.icons').parent().find('.link_hover_text').text(''); }
  );
